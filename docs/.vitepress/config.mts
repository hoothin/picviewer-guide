...
export default defineConfig({
  ...
  themeConfig: {
      ...
      ,footer: {
        message: 'Support the project: <a href="https://ko-fi.com/hoothin" target="_blank" rel="noopener noreferrer">Ko-fi</a> / <a href="https://afdian.com/@hoothin" target="_blank" rel="noopener noreferrer">愛發電</a>'
      }
  },
  sitemap: {
    hostname: site
